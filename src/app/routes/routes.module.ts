...
import {EncryptedAnswerResolver} from "../../services/resolvers.service";
...
const routes: Routes = [
  ...
  {
    path: 'Answer/Share/:EventId', component: AnswerComponent, title: 'Answer', resolve: {Event: EncryptedAnswerResolver}
  },
  {
